...
export class DataLabelHelper {
    ...
    private static calculateShiftForNoLegend(shift: number,
        ...
        const maxPossibleRightPosition: number = canOverflow ? chartWidth : shift + barWidth - gap;
    ...
    public static calculatePositionShift(settings: categoryLabelsSettings,
        ...
        const shift: number = dataPoint.value >= 0 ? 
                                this.calculateLabelPositionShift(settings, labelWidth, barCoordinates, isLegendRendered) : 
                                this.calculateLabelPositionShiftForNegativeValues(settings, labelWidth, barCoordinates, isLegendRendered);
    ...
    private static calculateLabelPositionShift(settings: categoryLabelsSettings,
        ...
        switch (settings.labelPosition) {
            ...
            default: {
                return isLegendRendered ? barX + barWidth / 2 - labelWidth / 2 : barX + barWidth + this.dataLabelMargin + backgroundMargin;
            }
        }
    }
    ...
    private static calculateLabelPositionShiftForNegativeValues(settings: categoryLabelsSettings,
        ...
        switch (settings.labelPosition) {
            ...
            default: {
                return isLegendRendered ? barX + barWidth / 2 - labelWidth / 2 : barX - this.dataLabelMargin - labelWidth - backgroundMargin;
            }
        }
    }
}