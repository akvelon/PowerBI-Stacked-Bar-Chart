...
import { DefaultOpacity, DimmedOpacity, d3Selection } from "./utils";
...
export class LassoSelectionForSmallMultiple {
    ...
    update(svgChart: d3Selection<any>, bars: d3Selection<any>, legendBucketFilled: boolean): void {
        ...
        this.svgChart.on( `mousedown${Constants.EventNameSpace}`, (e: MouseEvent) => { this.lasso.init( e ); });
        d3.select('html')
    ...
    private onClick(): void {
        const target: d3Selection<any> = d3.select(<any>this.lasso.mousedown.target);
